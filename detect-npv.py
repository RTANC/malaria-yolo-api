...
if __name__ == "__main__":
    ...
    os.system("rm -rvf output-npv output-npv.zip output-npv.txt && mkdir -p output-npv/fp")
...
#                 count += 1                
        ...
        plt.savefig(f"output-npv/{ex_path}{filename}.jpg", bbox_inches="tight", pad_inches=0.0)
        plt.close()
    print("infect found: {}".format(infect_img_count))